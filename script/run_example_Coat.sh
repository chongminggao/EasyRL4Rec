...
python examples/policy/run_A2C.py     --env CoatEnv-v0  --seed 2023 --cuda 1 --epoch 2  --num_leave_compute 1 --leave_threshold 0 --which_tracker avg --reward_handle "cat" --window_size 3 --read_message "pointneg"  --message "A2C-new"
python examples/policy/run_PG.py      --env CoatEnv-v0  --seed 2023 --cuda 0 --epoch 10   --num_leave_compute 1 --leave_threshold 0 --which_tracker avg --reward_handle "cat" --window_size 3 --read_message "pointneg"  --message "PG"
python examples/policy/run_PPO.py     --env CoatEnv-v0  --seed 2023 --cuda 2 --epoch 10   --num_leave_compute 1 --leave_threshold 0 --which_tracker avg --reward_handle "cat" --window_size 3 --read_message "pointneg"  --message "PPO"
# 2.2 offpolicy
python examples/policy/run_DQN.py     --env CoatEnv-v0  --seed 2023 --cuda 0 --epoch 10  --num_leave_compute 1 --leave_threshold 0 --which_tracker avg --reward_handle "cat" --window_size 3 --read_message "pointneg"  --message "DQN"
python examples/policy/run_QRDQN.py   --env CoatEnv-v0  --seed 2023 --cuda 3 --epoch 10  --num_leave_compute 1 --leave_threshold 0 --which_tracker avg --reward_handle "cat" --window_size 3 --read_message "pointneg"  --message "QRDQN"
python examples/policy/run_C51.py     --env CoatEnv-v0  --seed 2023 --cuda 2 --epoch 10  --num_leave_compute 1 --leave_threshold 0 --which_tracker avg --reward_handle "cat" --window_size 3 --read_message "pointneg"  --message "C51"
