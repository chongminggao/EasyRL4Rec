# run user model
python examples/usermodel/run_DeepFM_ensemble.py --env KuaiEnv-v0  --seed 2023 --cuda 0     --epoch 3 --n_models 3 --loss "pointneg" --message "pointneg"
python examples/usermodel/run_DeepFM_ensemble.py --env KuaiEnv-v0  --seed 2023 --cuda 0     --epoch 3 --tau 100 --n_models 1 --loss "pointneg" --message "CIRS_UM"
