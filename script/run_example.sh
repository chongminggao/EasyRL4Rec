...
python examples/policy/run_BCQ.py --env KuaiEnv-v0  --seed 2023 --cuda 2 --epoch 3  --num_leave_compute 1 --leave_threshold 0 --which_tracker avg --reward_handle "cat"  --unlikely-action-threshold 0.6 --window_size 3 --read_message "pointneg"  --message "BCQ"
...
python examples/policy/run_A2C.py     --env KuaiEnv-v0  --seed 2023 --cuda 3 --epoch 3  --num_leave_compute 1 --leave_threshold 0 --which_tracker avg --reward_handle "cat" --window_size 3 --read_message "pointneg"  --message "A2C"
# 2.2 offpolicy
