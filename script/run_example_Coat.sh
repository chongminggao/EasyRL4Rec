...
# test state_tracker
python examples/policy/run_A2C.py     --env CoatEnv-v0  --seed 2023 --cuda 1 --epoch 30 --which_tracker caser --reward_handle "cat" --window_size 5 --read_message "pointneg"  --message "A2C_caser"
python examples/policy/run_A2C.py     --env CoatEnv-v0  --seed 2023 --cuda 1 --epoch 30 --which_tracker gru --reward_handle "cat" --window_size 3 --read_message "pointneg"  --message "A2C_gru"
python examples/policy/run_A2C.py     --env CoatEnv-v0  --seed 2023 --cuda 1 --epoch 30 --which_tracker sasrec --reward_handle "cat" --window_size 3 --read_message "pointneg"  --message "A2C_sasrec"
python examples/policy/run_A2C.py     --env CoatEnv-v0  --seed 2023 --cuda 1 --epoch 30 --which_tracker nextitnet --reward_handle "cat" --window_size 3 --read_message "pointneg"  --message "A2C_nextitnet"

# run policy
# 1. Offline RL(Batch RL) (offpolicy)
python examples/policy/run_DiscreteCRR.py --env CoatEnv-v0  --seed 2023 --cuda 0 --epoch 3 --which_tracker avg --reward_handle "cat"  --window_size 3 --read_message "pointneg"  --message "DiscreteCRR-softmax"
...
# 2.2 offpolicy
python examples/policy/run_DQN.py     --env CoatEnv-v0  --seed 2023 --cuda 1 --epoch 3 --which_tracker avg --reward_handle "cat" --window_size 3 --read_message "pointneg"  --message "DQN"
...
python examples/advance/run_DORL.py       --env CoatEnv-v0  --seed 2023 --cuda 1 --epoch 100 --which_tracker avg --reward_handle "cat" --no_feature_level  --lambda_entropy 5     --window_size 3 --read_message "pointneg"  --message "DORL"
python examples/advance/run_Intrinsic.py  --env CoatEnv-v0  --seed 2023 --cuda 0 --epoch 100 --which_tracker avg --reward_handle "cat" --lambda_diversity 0.1 --lambda_novelty 0.1 --window_size 3 --read_message "pointneg"  --message "Intrinsic"
